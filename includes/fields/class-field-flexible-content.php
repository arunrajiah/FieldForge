...
class FieldForge_Field_Flexible_Content extends FieldForge_Field_Base {
	...
	public function render( int $post_id ): void {
		...
		$button_label = esc_html( $this->field['button_label'] ?? __( 'Add Layout', 'fieldom' ) );
		...
		if ( ! empty( $rows ) ) {
			...
			$html .= '<p class="fieldforge-fc-empty">' . esc_html__( 'No layouts added yet.', 'fieldom' ) . '</p>';
		}
	...
	private function render_row( int $i, array $row, array $layout, FieldForge_Field_Registry $registry, string $name ): string {
		...
		$html .= '<button type="button" class="button button-link fieldforge-fc-toggle">' . esc_html__( 'Collapse', 'fieldom' ) . '</button>';
		$html .= '<button type="button" class="button button-link-delete fieldforge-fc-remove">' . esc_html__( 'Remove', 'fieldom' ) . '</button>';
