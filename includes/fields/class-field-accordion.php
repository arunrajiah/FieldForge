...
class FieldForge_Field_Accordion extends FieldForge_Field_Base {
	...
	public function render( int $post_id ): void {
		$label    = esc_html( $this->field['label'] ?? __( 'Section', 'ar-fieldforge' ) );
		...
		echo '<span class="fieldforge-accordion-label">' . esc_html( $this->field['label'] ?? __( 'Section', 'ar-fieldforge' ) ) . '</span>';
